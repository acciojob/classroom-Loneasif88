...
public class StudentController {
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        ...
        students = studentService.findStudentsFromTeacher(teacher); // Assign list of student by calling service layer method
    ...
    public ResponseEntity<List<String>> getAllStudents(){
        List<String> students = null;
          students = studentService.findAllStudents(); // Assign list of student by calling service layer method
